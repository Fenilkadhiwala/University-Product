                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    if ($result->num_rows > 0) {
                                        echo "<h5 style='color:red;'>Attendance For This Day Is Already Marked</h5><br>";
                                        echo '<a name="viewAttendance" href="viewAttendance.php?date=' . $date . '" class="btn btn-primary">View Attendance</a>';

                                    } else {



                                        echo ' <form action="saveAttendance.php" method="post">
